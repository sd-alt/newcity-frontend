...
<template>
  <section class="page knowledge-page">
    <header class="page-head"><div><p class="eyebrow">标准 · 规则 · 案例</p><h1>知识检索与应用</h1></div><span class="count-mark">{{ items.length }}</span></header>
    ...
    <input v-model="keyword" class="search" type="search" placeholder="检索编码、标题或正文" @input="page = 1" />
...
.count-mark { color: #0c6d64; font: 700 24px/1 Georgia, serif; }
.form-grid { display: grid; gap: .4rem; }
.form-grid h3 { margin: 0; color: #173f43; font-size: 13px; }
.split { display: grid; grid-template-columns: 1fr 1fr; gap: .35rem; }.actions,.row-actions { display: flex; gap: .35rem; }.search { width: 100%; margin: .55rem 0; }
.knowledge-list { display: grid; gap: .35rem; }.knowledge-list article { display: flex; justify-content: space-between; gap: .45rem; padding: .55rem; border-left: 3px solid #0d756b; background: rgba(255,255,255,.92); }.knowledge-list article > div:first-child { display: grid; min-width: 0; gap: .12rem; }.knowledge-list span { width: max-content; padding: .08rem .25rem; background: #edf5f3; color: #0c6d64; font-size: 9px; }.knowledge-list strong { color: #183f43; font-size: 12px; }.knowledge-list p { margin: 0; max-height: 3.2em; overflow: hidden; color: #526663; font-size: 11px; }.knowledge-list small { color: #778783; }.row-actions { flex-direction: column; }.row-actions button { border: 0; background: transparent; color: #0d756b; font-size: 10px; }.row-actions .danger { color: #a33a31; }
.pager { display: flex; justify-content: center; gap: .5rem; margin: .5rem 0; font-size: 11px; }.pager button { border: 0; background: transparent; color: #0d756b; }.resource-evidence { display: grid; grid-template-columns: 1fr 1fr; gap: .35rem; }.resource-evidence div { display: grid; gap: .1rem; padding: .5rem; background: #eef4f2; }.resource-evidence span,.resource-evidence small { color: #647773; font-size: 10px; }.resource-evidence strong { color: #8a5c16; font: 700 20px/1.1 Georgia, serif; }.empty-state { padding: 1rem; border: 1px dashed #bccbc8; color: #687c78; text-align: center; font-size: 11px; }.ok-text { color: #087066; font-size: 12px; }
</style>
